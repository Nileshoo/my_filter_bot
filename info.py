...
MULTIPLE_DATABASE = bool(environ.get('MULTIPLE_DATABASE')) # Set True or False
...
MAX_BTN = int(environ.get('MAX_BTN'))
...
#---------------------------------------------------------------
#---------------------------------------------------------------
STREAM_MODE = bool(environ.get('STREAM_MODE')) # Set True or Flase
